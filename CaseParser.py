...
def generateHTMLReport(testResult):
    ...
    report_html.write("<tr bgcolor=#858585 align=center class=title><td width=\"250\">DataBase</td><td width=\"150\">ExecOpt</td><td width=\"100\">Run Times</td></tr>\n")
    report_html.write("<tr align=center bgcolor=#FFFFFF class=desc><td><B>"+param.server+"</B></td><td>" + param.execopt+ "</td><td>" +str(len(testResult.testsuite_list))+ "</td></tr>\n")
    ...
    report_html.write("<tr bgcolor=#858585 align=center class=title><td width=\"60\">Run Time</td><td width=\"250\">Test Suite</td><td width=\"100\">Num of Testcase</td><td width=\"200\">LogPath</td><td width=\"100\">Result</td><td width=\"100\">Pass Rate</td><td width=\"500\">RichTextLog</td></tr>\n")
#blue color: #034579
    ...
    report_html.write("<body><table cellpadding=\"0\" cellspacing=\"0\" align=\"center\"\n>")
    report_html.write(
        "<tr bgcolor=#858585 align=center class=title><td width=\"60\">Run Time</td><td width=\"150\">Test Suite</td><td width=\"60\">Exec ID</td><td width=\"200\">TestCaseName</td><td width=\"80\">Result</td><td width=\"500\">FailedInfo</td></tr>\n")
